...
CREATE TABLE `seat_type` (
  ...
  `seat_type_price` decimal(10,0) NOT NULL,
  `seat_type_description` text,
  PRIMARY KEY (`id`)
...
INSERT INTO `seat_type` VALUES (1,'Ghế thường',70000,'Ghế thông thường không phụ phí'),(2,'Ghế đôi',150000,'Ghế dành cho 2 người'),(3,'Ghế VIP',120000,'Ghế có vị trí tốt'),(4,'Ghế Deluxe',160000,'Ghế sang trọng');
